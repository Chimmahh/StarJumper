...
class World {
    constructor(world_cnv, sword_cnv) {
        ...
        this.eye = new Eye(100, 100, this.player)
    ...
    updateEnemies() {
        ///// EYE /////
        this.eye.update()
        if (this.eye.x_pos + this.eye.width/2 > this.width) {
            this.eye.x_pos = this.width - this.eye.width/2
            this.eye.vx *= -1
            this.eye.x_pos += this.eye.vx
        } else if (this.eye.x_pos - this.eye.width/2 < 0) {
            this.eye.x_pos = this.eye.width/2
            this.eye.vx *= -1
            this.eye.x_pos += this.eye.vx
        } else if (this.eye.y_pos + this.eye.height/2 > this.height - this.ground_height) {
            this.eye.y_pos = this.height - this.ground_height - this.eye.height/2
            this.eye.vy *= -1
            this.eye.y_pos += this.eye.vy
        } else if (this.eye.y_pos - this.eye.height/2 < 0) {
            this.eye.y_pos = this.eye.height/2
            this.eye.vy *= -1
            this.eye.y_pos += this.eye.vy
        }
        ///// ENEMIES /////
